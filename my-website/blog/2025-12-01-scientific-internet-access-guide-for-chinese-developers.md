...
第三步：回到 Clash Verge 界面，在【订阅】栏找到你的自用节点模块，右键选择【编辑节点】。
![图片3.29](../src/image/图片3.29.png)

在弹出界面左侧，输入你购买的静态IP内容，格式为： 
![图片3.30](../src/image/图片3.30.png)
...
第四步：回到 Clash Verge 【订阅】栏，对你的自用节点右键选择【编辑代理组】
弹出界面设置如下：
![图片3.31](../src/image/图片3.31.png)
